import {Player, managePlayerMovement, killPlayer} from "./game-modules/Player.js";
...
const Game = () => {
    ...
    function manageColliders(){
        ...
        gameSettings.scene.physics.add.collider(gameSettings.player.himSelf, gameSettings.scene.worldLayer);

        gameSettings.scene.physics.add.collider(gameSettings.enemies.zombie.himSelf, gameSettings.scene.worldLayer);

        // OverLaps
        gameSettings.scene.physics.add.overlap(gameSettings.player.himSelf, gameSettings.scene.overlapLayer);
        gameSettings.scene.physics.add.overlap(gameSettings.player.himSelf, gameSettings.enemies.zombie.himSelf, attack);
    ...
    function manageCamera(){
        //gameSettings.scene.cameras.main.startFollow(gameSettings.player.himSelf);
    ...
    function killPlayer(){
        if(!gameSettings.scene.gameOver){
            ...
            gameSettings.player.killPlayer();
            //gameSettings.player.himSelf.setTexture("player", "adventurer_hurt");
