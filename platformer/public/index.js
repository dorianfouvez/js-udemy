...
function preload(){
    ...
    // Images
    // Player
    this.load.image("player", "./images/players/player_stand.png");
    this.load.image("player_kick", "./images/players/player_kick.png");
    this.load.image("player_walk1", "./images/players/player_walk1.png");
    this.load.image("player_walk2", "./images/players/player_walk2.png");
    // Buttons
    this.load.image("down", "./images/buttons/yellow_sliderDown.png");
    this.load.image("up", "./images/buttons/yellow_sliderUp.png");
    // Grounds
    this.load.image("grassGround", "./images/plateforms/groundGrass.png");
    // Background
    this.load.image("grass", "./images/backgrounds/backgroundColorGrass.png");
    // Enemies
    this.load.image("ladyBug", "./images/enemies/ladyBug.png");
    // SpriteSheets
    this.load.spritesheet("zombieSPS", "./images/enemies/zombie_tilesheet.png", {frameWidth: 80, frameHeight: 110});
